...
INSERT INTO component (class_id, name, designation, vendor_code, unit_id, description, weight_kg, material, created_at, created_by)
SELECT cl.id, 'Втулка коническая', '1210x24', 'BSH-1210-24', u.id, 'Коническая втулка диаметр 24 мм', 0.12, 'Сталь 45', NOW(), 'system'
FROM component_class cl, unit_of_measure u
...
INSERT INTO material (class_id, name, designation, standard, specification, material_type, unit_id, density, description, created_at, created_by)
